...
namespace Universe
{
    ...
    public partial class TestSetup : GameWorld
    {
        ...
        private readonly Dictionary<Vector2I, Vector2I> _tileState = new();
        private static readonly Vector2I TileBlank = new Vector2I(27, 6);
        ...
        private void UpdateTile(Vector2I coords, int sourceId, Vector2I atlasCoords)
        {
            if (_tileState.TryGetValue(coords, out var current) && current == atlasCoords)
                return; // nichts zu tun

            _tileMap.SetCell(coords, sourceId, atlasCoords);
            _tileState[coords] = atlasCoords;
        }
